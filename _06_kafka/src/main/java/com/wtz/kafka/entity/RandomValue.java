...
/**
 * @author tiezhu
 * @date 2021/3/1 星期一 Company dtstack
 */
public class RandomValue {
    ...
    public static String buildJsonData(int i) throws JSONException {
        ...
        //            tostring = "  ";
        //        } else {
        //            tostring = new Date(timestamp.getTime()).toString();
        //        }
        //        result.put("todayDate", tostring);
        //        if (i % 10 != 0) {
        //            result.put("todayTime", new Time(timestamp.getTime()).toString());
        //        } else {
        //            result.put("todayTime", " ");
        //        }
        //        result.put("price", 0.7 * i);
        //        result.put("phone", RandomValue.getTel());
        //        result.put("qq", randomDataGenerator.nextLong(1000000L, 99999999999L));
        //
        //        result.put("sex", RandomValue.getAddress().get("sex"));
        //        result.put("money", BigDecimal.valueOf(0.9 * randomDataGenerator.nextInt(1,
        // 1000)));
        //
        //        if (i % 2 == 0) {
        //            result.put("proName", "FlinkStreamSQL");
        //        } else {
        //            result.put("proName", "FlinkSQL");
        //        }
        //
        //        result.put("timeStart", System.currentTimeMillis());
        //
        //        data.put("math", randomDataGenerator.nextInt(60, 100));
        //        data.put("english", randomDataGenerator.nextInt(70, 90));
        //        result.put("grande", data.toJSONString());
